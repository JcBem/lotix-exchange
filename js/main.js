...
const I18N = {
  zh: {
    meta_title: "LOTIX 洛钛克斯 — 即将上线的数字资产交易平台 · 内测预约",
    meta_desc: "LOTIX 洛钛克斯是一家正在筹备中的数字资产交易平台，即将提供安全、专业、便捷的比特币、以太坊等加密货币现货与合约交易服务，内测预约现已开启。",
    announce_text: "LOTIX 平台正在筹备中，预计近期正式上线。现在预约内测，可享早期用户专属权益。",
    announce_link: "立即预约 →",
    ...
    hero_desc: "LOTIX 洛钛克斯是一家初创数字资产交易平台，正在为正式上线全力筹备。未来我们将提供比特币、以太坊等主流加密货币的现货与合约交易服务，以银行级安全架构、顶级交易深度与 7×24 小时多语言客服，打造安心、专业的交易体验。",
    hero_cta_primary: "预约抢先体验", hero_cta_secondary: "了解 LOTIX",
    ...
    features_sub: "从现货到合约，从理财到支付，LOTIX 满足你对加密世界的全部需求",
    f1_t: "银行级安全保障",
    ...
    step1_t: "预约登记",
    step1_p: "留下你的邮箱或手机号，加入 LOTIX 早期用户候补名单，上线第一时间通知你。",
    step2_t: "账户开通",
    ...
    app_sub: "LOTIX App 正与网页端同步开发中。现在预约上线提醒，上线第一时间体验移动端交易：价格提醒、一键跟单、指纹登录，让盈利机会不再错过。",
    ...
    footer_about: "LOTIX 洛钛克斯是一家初创数字资产交易平台，目前正处于筹备阶段。我们致力于为全球用户打造安全、专业、便捷的加密货币交易服务，平台即将上线，敬请期待。",
    fcol_product: "产品服务",
    ...
    footer_copy1: "© 2026 LOTIX 洛钛克斯. 平台正在筹备中，暂未开放任何交易与注册服务，页面数据仅为界面演示。",
    footer_copy2: "加密资产交易存在较大价格波动风险，正式上线后请谨慎评估自身风险承受能力。",
  },
  en: {
    meta_title: "LOTIX — Upcoming Digital Asset Trading Platform · Beta Waitlist",
    meta_desc: "LOTIX is a digital asset trading platform now in preparation, soon to offer secure, professional spot and futures trading for Bitcoin, Ethereum and more. Beta signup is open.",
    announce_text: "LOTIX is in preparation and expected to launch soon. Join the beta waitlist now for exclusive early-bird benefits.",
    ...
    features_sub: "From spot to futures, from earn to payments — LOTIX covers everything you need in the crypto world",
    ...
    step1_t: "Sign Up",
    step1_p: "Leave your email or phone number to join the LOTIX early-user waitlist and be notified the moment we launch.",
    ...
    app_sub: "The LOTIX App is being built alongside the web platform. Reserve launch alerts now to experience mobile trading first: price alerts, one-tap copy trading and fingerprint login — never miss a profit opportunity.",
    ...
    footer_about: "LOTIX is a startup digital asset exchange currently in the preparation stage. We are committed to building secure, professional and convenient cryptocurrency trading services for users worldwide. The platform is launching soon — stay tuned.",
    ...
    footer_copy1: "© 2026 LOTIX. The platform is in preparation; no trading or registration services are available yet. Data shown is for UI demonstration only.",
