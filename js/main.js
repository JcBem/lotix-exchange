/* ============================================================
   ...
   - 移动端菜单 / 导航滚动效果
   - 滚动入场动画 + 数字滚动
   - 行情表格 + 跑马灯（Binance / OKX 公开 API 实时数据）
   - Canvas 价格走势图（真实 K 线，Hero 卡片 & 手机模型）
   ============================================================ */

// ---------- 行情币种（初始为占位，数值由实时行情 API 填充） ----------
const SYMBOLS = ["BTC", "ETH", "SOL", "BNB", "XRP", "DOGE", "ADA", "AVAX"];
const COINS = [
  { sym: "BTC",  name: "比特币", nameEn: "Bitcoin",   price: null, change: null, high: null, low: null, vol: null, icon: "₿", cls: "coin-btc" },
  { sym: "ETH",  name: "以太坊", nameEn: "Ethereum",  price: null, change: null, high: null, low: null, vol: null, icon: "Ξ", cls: "coin-eth" },
  { sym: "SOL",  name: "索拉纳", nameEn: "Solana",    price: null, change: null, high: null, low: null, vol: null, icon: "◎", cls: "coin-sol" },
  { sym: "BNB",  name: "币安币", nameEn: "BNB",       price: null, change: null, high: null, low: null, vol: null, icon: "B", cls: "coin-bnb" },
  { sym: "XRP",  name: "瑞波币", nameEn: "XRP",       price: null, change: null, high: null, low: null, vol: null, icon: "X", cls: "coin-xrp" },
  { sym: "DOGE", name: "狗狗币", nameEn: "Dogecoin",  price: null, change: null, high: null, low: null, vol: null, icon: "Ð", cls: "coin-doge" },
  { sym: "ADA",  name: "艾达币", nameEn: "Cardano",   price: null, change: null, high: null, low: null, vol: null, icon: "A", cls: "coin-ada" },
  { sym: "AVAX", name: "雪崩币", nameEn: "Avalanche", price: null, change: null, high: null, low: null, vol: null, icon: "▲", cls: "coin-avax" },
];

// 实时数据源状态（null=连接中 / "Binance" / "OKX"），liveError=true 表示全部源均失败
...
const I18N = {
  zh: {
    meta_title: "LOTI 乐缇 — 即将上线的数字资产交易平台 · 内测预约",
    meta_desc: "LOTI 乐缇是一家正在筹备中的数字资产交易平台，即将提供安全、专业、便捷的比特币、以太坊等加密货币现货与合约交易服务，内测预约现已开启。",
    ...
    hero_desc: "LOTI 乐缇是一家初创数字资产交易平台，正在为正式上线全力筹备。未来我们将提供比特币、以太坊等主流加密货币的现货与合约交易服务，以银行级安全架构、顶级交易深度与 7×24 小时多语言客服，打造安心、专业的交易体验。",
    ...
    footer_about: "LOTI 乐缇是一家初创数字资产交易平台，目前正处于筹备阶段。我们致力于为全球用户打造安全、专业、便捷的加密货币交易服务，平台即将上线，敬请期待。",
    fcol_product: "产品服务",
    ...
    footer_copy1: "© 2026 LOTI 乐缇. 平台正在筹备中，暂未开放任何交易与注册服务，页面数据仅为界面演示。",
    footer_copy2: "加密资产交易存在较大价格波动风险，正式上线后请谨慎评估自身风险承受能力。",
    about_tag: "关于 LOTI · ABOUT",
    about_title: "立足南非 · 辐射全非洲的合规区块链科技企业",
    about_sub: "LOTI 乐缇由传统实业龙头企业与国际投资机构联合发起，总部位于约翰内斯堡，构建「技术‑算力‑交易‑投资」一体化闭环生态。",
    about_position: "企业定位",
    about_position_p: "南非本土持牌区块链金融科技企业，总部位于约翰内斯堡。",
    about_shareholders: "股东背景",
    about_shareholders_p: "由传统实业龙头企业与国际投资机构联合发起，拥有雄厚实体产业资源与跨境资本实力。",
    about_biz: "核心业务",
    biz1: "区块链底层技术研发",
    biz2: "合规数字资产交易平台运营",
    biz3: "算力基础设施建设",
    biz4: "数字产业战略投资",
    biz5: "生态通证 LOTIX",
    biz5_p: "承担生态流通、权益激励功能",
    about_adv: "核心优势",
    adv1: "南非属地合规运营，熟悉非洲金融市场环境",
    adv2: "实业资本加持，资金与产业链资源充足",
    adv3: "全栈技术团队，覆盖研发、运维、风控、合规",
    adv4: "完整闭环生态：技术‑算力‑交易‑投资一体化布局",
    about_compliance: "合规资质",
    about_compliance_p: "严格遵循南非 FSCA、FIC 监管要求，落实反洗钱、KYC 客户身份核验制度，完成当地相关备案，深耕非洲本土市场。",
    comp_aml: "AML 反洗钱",
    comp_kyc: "KYC 身份核验",
    about_strategy: "发展战略",
    about_strategy_p: "立足南非，辐射全非洲大陆。持续加大技术研发，完善本地化服务，拓展非洲各国市场；丰富 LOTIX 通证应用场景，联动实体产业，打造非洲标杆区块链生态。",
    about_vision: "企业愿景",
    about_vision_p: "成为非洲一流、具备全球影响力的区块链科技企业，以合规技术赋能非洲数字经济发展。",
    live_loading: "实时行情连接中…",
    live_error: "实时行情暂时不可用，正在自动重试…",
  },
  en: {
    ...
    about_tag: "ABOUT LOTI",
    about_title: "A Compliant Blockchain Technology Company Rooted in South Africa, Reaching Across the Continent",
    about_sub: "LOTI (Leti) was jointly founded by leading traditional-industry enterprises and international investment institutions. Headquartered in Johannesburg, we are building an integrated closed-loop ecosystem spanning technology, computing power, trading and investment.",
    about_position: "Company Position",
    about_position_p: "A locally-licensed blockchain fintech enterprise headquartered in Johannesburg, South Africa.",
    about_shareholders: "Shareholder Background",
    about_shareholders_p: "Jointly founded by leading traditional-industry enterprises and international investment institutions, with solid real-industry resources and cross-border capital strength.",
    about_biz: "Core Business",
    biz1: "Blockchain Underlying-Technology R&D",
    biz2: "Compliant Digital-Asset Trading Platform Operation",
    biz3: "Computing-Power Infrastructure Construction",
    biz4: "Strategic Investment in Digital Industries",
    biz5: "Ecosystem Token LOTIX",
    biz5_p: "Powering ecosystem circulation and community incentives",
    about_adv: "Core Advantages",
    adv1: "Local-compliant operation in South Africa, with an in-depth understanding of African financial markets",
    adv2: "Backed by industrial capital, with abundant funding and industrial-chain resources",
    adv3: "Full-stack technical team covering R&D, operations, risk control and compliance",
    adv4: "Closed-loop ecosystem: an integrated technology–computing power–trading–investment layout",
    about_compliance: "Compliance",
    about_compliance_p: "Operates in strict accordance with South Africa's FSCA and FIC regulations. Implements anti-money-laundering and KYC procedures and has completed local filings, deeply rooted in the African market.",
    comp_aml: "AML",
    comp_kyc: "KYC",
    about_strategy: "Development Strategy",
    about_strategy_p: "Based in South Africa and expanding across the African continent. We keep investing in technology R&D, improving localized services and expanding into other African markets; we will enrich real-world use cases for the LOTIX token and partner with real-economy sectors to build Africa's benchmark blockchain ecosystem.",
    about_vision: "Our Vision",
    about_vision_p: "To become a top-tier, globally-influential blockchain technology enterprise in Africa, empowering Africa's digital economy through compliant technology.",
    live_loading: "Connecting to live market data…",
    live_error: "Live market data temporarily unavailable, retrying…",
  },
};
...
// 交易所式自适应精度：价格越大小数越少，低价币保留足够位数，避免舍入误差
...
const fmtVol = (v) => {
  ...
  return (v >= 1000 ? Math.round(v).toLocaleString("en-US") : v.toFixed(2)) + " BTC";
};
...
function renderMarket() {
  ...
  wrap.innerHTML = COINS.map(
    ...
    <div class="market-row" data-sym="${c.sym}">
      ...
      <span class="col-change mk-change ${c.change == null ? "" : c.change >= 0 ? "up" : "down"}">
        ${fmtChange(c.change)}
      </span>
...
function renderMarquee() {
  ...
  const item = (c) => `
    <span class="marquee-item">
      ...
      <span class="${c.change == null ? "" : c.change >= 0 ? "up" : "down"}">${
        c.change == null ? "—" : `${c.change >= 0 ? "▲" : "▼"} ${Math.abs(c.change).toFixed(2)}%`
      }</span>
    </span>`;
...
/* ============================================================
   实时行情数据层
   主数据源：Binance 官方公开市场数据（无需 API Key，支持 CORS）
   容灾源：OKX 公开行情 API
   全部源均失败时保留上一次数据，绝不使用随机数伪造行情
   ============================================================ */
const BINANCE_HOSTS = [
  "https://data-api.binance.vision", // 官方公开数据专用域名
...
// 24h 行情快照：{ SYM: { price, change, high, low, vol } }
async function fetchTickerMap() {
  ...
  for (const base of BINANCE_HOSTS) {
    try {
      const arr = await fetchJson(`${base}/api/v3/ticker/24hr?symbols=${q}`);
      if (Array.isArray(arr) && arr.length) {
        ...
        if (map.BTC && map.BTC.price) return { map, source: "Binance" };
      }
    } catch (e) {
      console.warn("[LOTI] Binance ticker failed:", base, e.message);
    }
  }
  // 2) OKX
  try {
    ...
    const map = {};
    (j.data || []).forEach((t) => {
      const sym = t.instId && t.instId.endsWith("-USDT") ? t.instId.replace("-USDT", "") : null;
      if (!sym || !SYMBOLS.includes(sym)) return;
      const last = parseFloat(t.last);
      const open = parseFloat(t.open24h);
      map[sym] = {
        price: last,
        change: open ? ((last - open) / open) * 100 : null,
        high: parseFloat(t.high24h),
        low: parseFloat(t.low24h),
        vol: parseFloat(t.vol24h),
      };
    });
    if (map.BTC && map.BTC.price) return { map, source: "OKX" };
  } catch (e) {
    console.warn("[LOTI] OKX ticker failed:", e.message);
  }
  return null;
}

// 真实 K 线收盘价序列（Binance klines；OKX candles 容灾，OKX 为倒序需 reverse）
async function fetchCloses(sym, interval = "1h", limit = 40) {
  for (const base of BINANCE_HOSTS) {
    try {
      const arr = await fetchJson(
        `${base}/api/v3/klines?symbol=${sym}USDT&interval=${interval}&limit=${limit}`
      );
      if (Array.isArray(arr) && arr.length) return arr.map((k) => parseFloat(k[4]));
    } catch (e) {
      console.warn("[LOTI] Binance klines failed:", base, e.message);
    }
  }
  try {
    const j = await fetchJson(
      `https://www.okx.com/api/v5/market/candles?instId=${sym}-USDT&bar=${interval.toUpperCase()}&limit=${limit}`
    );
    if (j.data && j.data.length) return j.data.map((k) => parseFloat(k[4])).reverse();
  } catch (e) {
    console.warn("[LOTI] OKX candles failed:", e.message);
  }
  return null;
}
...
const heroVolEl = document.getElementById("heroVol");
function applyHero(b) {
  heroPriceEl.textContent = fmtPrice(b.price);
  heroChangeEl.textContent = fmtChange(b.change);
  heroChangeEl.className = `ticker-change ${b.change == null ? "" : b.change >= 0 ? "up" : "down"}`;
  heroHighEl.textContent = fmtPrice(b.high);
  heroLowEl.textContent = fmtPrice(b.low);
  heroVolEl.textContent = fmtVol(b.vol);
}

// 手机模型里的币种行
function applyPhoneRows() {
  document.querySelectorAll(".ph-row[data-phsym]").forEach((row) => {
    const c = COINS.find((x) => x.sym === row.dataset.phsym);
    if (!c || c.price == null) return;
    row.querySelector(".ph-p").textContent = fmtPrice(c.price);
    const chg = row.querySelector(".ph-chg");
    chg.textContent = fmtChange(c.change);
    chg.className = "ph-chg " + (c.change == null ? "" : c.change >= 0 ? "up" : "down");
  });
}

// 数据源状态标识
function updateLiveLabel() {
  const dot = document.querySelector("#liveSource .live-dot");
  const txt = document.getElementById("liveSourceText");
  if (!txt) return;
  if (liveDataSource) {
    if (dot) dot.classList.add("live");
    txt.textContent = (currentLang === "zh" ? "实时行情 · " : "Live · ") + liveDataSource;
  } else if (liveError) {
    if (dot) dot.classList.remove("live");
    txt.textContent = t("live_error");
  } else {
    if (dot) dot.classList.remove("live");
    txt.textContent = t("live_loading");
  }
}

// 将一批实时快照写入页面
function applyTickers(map) {
  COINS.forEach((c) => {
    const d = map[c.sym];
  ...
  if (btc && btc.price != null) {
    applyHero(btc);
    if (heroPts.length) heroPts[heroPts.length - 1] = btc.price;
    drawHero();
  }
  applyPhoneRows();
  const eth = COINS.find((c) => c.sym === "ETH");
  if (eth && eth.price != null && phonePts.length) {
    phonePts[phonePts.length - 1] = eth.price;
    drawPhone();
  }
}

async function refreshTickers() {
  const r = await fetchTickerMap();
  if (r) {
    liveDataSource = r.source;
    liveError = false;
    applyTickers(r.map);
  } else {
    liveError = true;
    console.warn("[LOTI] all ticker sources unavailable, keep last data");
  }
  updateLiveLabel();
}
...
function drawChart(canvas, points, colorUp, colorDown) {
  ...
  // 数据未到达时只显示加载提示，绝不绘制虚构曲线
  if (!points || points.length < 2) {
    ctx.fillStyle = "rgba(168,176,194,.55)";
    ctx.font = "12px Inter, sans-serif";
    ctx.textAlign = "center";
    ctx.fillText(currentLang === "zh" ? "K 线加载中…" : "Loading chart…", w / 2, h / 2);
    return;
  }
...
// 加载真实 K 线：Hero 用 BTC 1h×40，手机模型用 ETH 1h×28；每 60 秒刷新
async function refreshCharts() {
  const btc = await fetchCloses("BTC", "1h", 40);
  if (btc && btc.length) {
    heroPts = btc;
    klineIds.BTC = null;
    drawHero();
  }
  const eth = await fetchCloses("ETH", "1h", 28);
  if (eth && eth.length) {
    phonePts = eth;
    klineIds.ETH = null;
    drawPhone();
...
/* ============================================================
   WebSocket 秒级实时推送（Binance 公开行情流）
   - 8 币种 24hr miniTicker：最新价/开盘价/高低/成交量
   - BTC、ETH 1h K 线：走势图末端实时跟随
   - 断开自动重连；不可用时 REST 10s 轮询始终作为兜底
   ============================================================ */
let wsLive = null;
...
const klineIds = { BTC: null, ETH: null };
...
function flushLiveUI() {
  ...
  requestAnimationFrame(() => {
    ...
    renderMarquee();
    const btc = COINS.find((c) => c.sym === "BTC");
    if (btc && btc.price != null) applyHero(btc);
    applyPhoneRows();
    if (heroDirty) { drawHero(); heroDirty = false; }
    if (phoneDirty) { drawPhone(); phoneDirty = false; }
  });
}
...
function handleMiniTicker(d) {
  ...
  c.price = last;
  if (open) c.change = ((last - open) / open) * 100;
  c.high = parseFloat(d.h);
  c.low = parseFloat(d.l);
  c.vol = parseFloat(d.v);
  if (sym === "BTC" && heroPts.length) { heroPts[heroPts.length - 1] = last; heroDirty = true; }
  if (sym === "ETH" && phonePts.length) { phonePts[phonePts.length - 1] = last; phoneDirty = true; }
  flushLiveUI();
}

function handleKlinePush(sym, k) {
  const pts = sym === "BTC" ? heroPts : phonePts;
  if (!pts.length) return;
  const close = parseFloat(k.c);
  if (klineIds[sym] === null || k.t === klineIds[sym]) {
    klineIds[sym] = k.t;
  ...
  if (sym === "BTC") heroDirty = true;
  else phoneDirty = true;
  flushLiveUI();
}

const WS_STREAMS = [
  ...SYMBOLS.map((s) => s.toLowerCase() + "usdt@miniTicker"),
  "btcusdt@kline_1h",
  "ethusdt@kline_1h",
].join("/");
const WS_URL = "wss://stream.binance.com:443/stream?streams=" + WS_STREAMS;
...
function connectWS() {
  ...
  const openTimer = setTimeout(() => {
    if (!wsConnected) { try { ws.close(); } catch (e) {} }
  }, 8000);
  ...
  ws.onmessage = (ev) => {
    ...
    const d = msg.data;
    if (!d) return;
    if (d.e === "24hrMiniTicker") handleMiniTicker(d);
    else if (d.e === "kline" && d.k) handleKlinePush(d.s === "BTCUSDT" ? "BTC" : "ETH", d.k);
  };
  ws.onerror = () => { /* onclose 会兜底处理 */ };
  ws.onclose = () => {
    wsConnected = false;
    scheduleWSRetry();
  };
...
function scheduleWSRetry() {
  if (wsRetry >= 8) return; // 放弃后由 REST 10s 轮询（含 OKX 容灾）持续供数
  wsRetry += 1;
  setTimeout(connectWS, Math.min(3000 * wsRetry, 15000));
}
connectWS();
